...
public class ServerBasic extends AbstractVerticle {
    ...
    final Logger LOG = LoggerFactory.getLogger(ServerBasic.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
        ...
        server.requestHandler(router)
                .listen(8080, ar -> {
                    if (ar.succeeded()) {
                        LOG.info("vertx-restful-lab: Deploy ServerBasic Verticle in the port: {}", ar.result().actualPort());
    ...
    public static void main(String[] args) {
        ...
        vertx.deployVerticle(new ServerBasic());
    }
