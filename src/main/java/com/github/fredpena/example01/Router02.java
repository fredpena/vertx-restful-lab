 ...
 */
public class Router02 extends AbstractVerticle {

    final Logger LOG = LoggerFactory.getLogger(Router02.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
         ...
         *
         * Cuando realizamos peticiones podemos enviar parámetros tanto en la url como en el cuerpo
         * de la petición. Anteriormente vimos como poder recoger esos parámetros de la url con el
         * método getParam. En cambio para poder recoger los parámetros en el cuerpo de las peticiones
         * tenemos que activar un handler. Esto lo podemos hacer añadiendo la siguiente linea antes de
         * cualquier petición que vaya a necesitar obtener datos
         */
        ...
        router.route(HttpMethod.POST, "/user")
                ...
                .handler(routingContext -> {
                    LOG.info("vertx-restful-lab: Router:HttpMethod.POST /user");
        ...
        router.post("/client")
                .produces("application/json")
                .handler(routingContext -> {
                    LOG.info("vertx-restful-lab: Router:post /client");
                    JsonObject object = routingContext.getBodyAsJson();
         ...
         * devolverá Response1 - Response2. Primero se ejecutará el primer handler
         * y a continuación gracias a la llamada a next se ejecutará el segundo handler.
         */
        router.get("/user/profile")
                .produces("application/json")
                .handler(routingContext -> {
                    LOG.info("vertx-restful-lab: Router:get /user/profile: Response 1");
        ...
        router.get("/user/profile")
                .produces("application/json")
                .handler(routingContext -> {
                    LOG.info("vertx-restful-lab: Router:get /user/profile: Response 2");
        ...
        /**
         * Si quisiéramos mantener algún tipo de dato entre los distintos handlers y
         * únicamente durante el tiempo de vida de la petición podríamos usar el
         * RoutingContext para ello.
         *
         * En el primer manejador se almacenaría la cadena Hello con la clave info,
         * posteriormente en el segundo, se extraería esa cadena y se concatenaría
         * con la cadena World! para devolverla al usuario. Después de esto se limpiaría
         * el RoutingContext y la clave info no existiría en la siguiente petición.
         */
        router.route("/user/profile2")
                .produces("application/json")
                .handler(routingContext -> {
                    LOG.info("vertx-restful-lab: Router:route /user/profile2");
        ...
        server.requestHandler(router)
                .listen(8080, ar -> {
                    if (ar.succeeded()) {
                        LOG.info("vertx-restful-lab: Deploy Router02 Verticle in the port: {}", ar.result().actualPort());
    ...
    public static void main(String[] args) {
        ...
        vertx.deployVerticle(new Router02());
    }
}
